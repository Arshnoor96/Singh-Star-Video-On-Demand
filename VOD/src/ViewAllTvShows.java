    ...
    class GetAllMovies implements Runnable {
        ...
        public void run() {
            try {
                ...
                serverOut.writeBytes("sendGenreForTv\r\n");
                while (true) {
                ...
                if (algenre.size() == 0) {
                    JOptionPane.showMessageDialog(rootPane, "No TvSHows found!!");
                    dispose();
                    return;
                }
                ...
                for (int i = 0; i < algenre.size(); i++) {
                    ...
                    serverOut.writeBytes("sendTvShows\r\n");
                    ...
                    while (true) {
                        ...
                        if (inpu.equals("done")) {
                            ...
                            int videoid = serverInp.readInt();
                            String type = serverInp.readUTF();

                            alepisodegenre.add(new EpisodeGenre(videoid, name, director, prducer, type,
                                    cover, square, genre));
                        }
                    }
        ...
        private void showPanels(String genre, ArrayList<EpisodeGenre> alepisodegenre) {
            try {
                int x = 10;
                int y = 10;
                ...
                for (int i = 0; i < alepisodegenre.size(); i++) {
                    EpisodeGenre tvData = alepisodegenre.get(i);
                    SingleImage image = new SingleImage();
                    String filename1 = tvData.squarephoto;
                    ...
                    image.lbImage.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            ViewAllEpisodes viewallepisodes =new ViewAllEpisodes(tvData.vid);
                            viewallepisodes.setVisible(true);
                        }
                    });
